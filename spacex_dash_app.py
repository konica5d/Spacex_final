...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        # Create a pie chart showing the total success vs. failed launches for all sites
        fig = px.pie(
        ...
        # Calculate the success and failed launches for the selected site
        success_count = filtered_df[filtered_df['class'] == 1]['class'].count()
        failed_count = filtered_df[filtered_df['class'] == 0]['class'].count()
        
        # Create a pie chart showing the success vs. failed launches for the selected site
        fig = px.pie(
            names=['Success', 'Failed'],
...
def update_scatter_chart(selected_site, payload_range):
    if selected_site == 'ALL':
        ...
        title = f'{selected_site}: Payload vs. Outcome'
